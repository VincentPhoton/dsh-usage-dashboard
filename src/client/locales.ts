...
export const zh = {
  ...
  'pricing.splitNote': '高峰时段为北京时间 {windows}（周一至周五），其余为闲时（价格减半）；每条用量按发生时刻生效的官方价格估算。',
  ...
  'peak.schedule': '高峰时段为北京时间 {windows}（周一至周五），闲时价格减半。',
...
export const en: Record<LocaleKey, string> = {
  ...
  'pricing.splitNote': 'Peak periods are {windows} Beijing time, Monday to Friday; off-peak rates are half price. Each record is estimated at the official rates in force when it was written. ',
  ...
  'peak.schedule': 'Peak periods are {windows} Beijing time, Monday to Friday; off-peak rates are half price. ',
