...
export const zh = {
  ...
  'pricing.visionNote': 'deepseek-v4-flash-vision-exp 与 deepseek-v4-flash 是旧模型名，现由 V4.1-Flash 承接、按 Flash 价计费；图片按尺寸折算 token，与文本一并计费。',
...
export const en: Record<LocaleKey, string> = {
  ...
  'pricing.visionNote': 'deepseek-v4-flash-vision-exp and deepseek-v4-flash are legacy names for the model now served by V4.1-Flash and billed at Flash rates; images are converted to tokens by size and charged together with text. ',
