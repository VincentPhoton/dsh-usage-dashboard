...
export const zh = {
  ...
  'pricing.splitNote': '高峰时段为北京时间 {windows}，其余为闲时（价格减半）；{date} 之前的用量仍按当时的旧价估算。',
  'pricing.visionNote': 'deepseek-v4-flash-vision-exp 与 flash 同价；图片按尺寸折算 token，与文本一并计费。',
...
export const en: Record<LocaleKey, string> = {
  ...
  'pricing.splitNote': 'Peak periods are {windows} Beijing time; off-peak rates are half price. Usage before {date} is still estimated at the old rates of that time. ',
  'pricing.visionNote': 'deepseek-v4-flash-vision-exp is billed like flash; images are converted to tokens by size and charged together with text. ',
