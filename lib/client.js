...
// src/client/cache.ts
var LS_VERSION = 2;
var beijingDayKey = (ms) => new Date(ms + 8 * 36e5).toISOString().slice(0, 10);
...
function createCache(ttlMs, storageKey, isUsable, options) {
...
var usageIsUsable = (res) => {
  ...
  const data = res.data;
  return data !== void 0 && Array.isArray(data.daily) && Array.isArray(data.hourly) && Array.isArray(data.heatmap) && Array.isArray(data.models) && Array.isArray(data.sessions) && typeof data.sessionCount === "number" && data.coverage?.scope === "local-dsh-session-logs" && typeof data.coverage.scannedSessions === "number" && typeof data.coverage.skippedRecords === "number" && Array.isArray(data.windows) && data.windows.length === USAGE_WINDOW_DAYS.length && USAGE_WINDOW_DAYS.every((days) => data.windows.some((window2) => window2.days === days)) && data.windows.every((window2) => Array.isArray(window2.daily) && window2.daily.length === window2.days && Array.isArray(window2.hourly) && window2.hourly.length === 24 && Array.isArray(window2.models) && Array.isArray(window2.sessions)) && data.vision !== void 0 && typeof data.vision.images === "number" && typeof data.vision.imageTokens === "number" && typeof data.vision.cost === "number" && Array.isArray(data.visionDaily) && Array.isArray(data.visionSessions) && data.windows.every((window2) => window2.vision !== void 0 && Array.isArray(window2.visionDaily) && Array.isArray(window2.visionSessions)) && data.totals !== void 0 && typeof data.totals.cacheSavings === "number" && data.summary?.today !== void 0 && Array.isArray(data.pricing?.tiers) && data.peakSplit?.peak !== void 0;
};
var balanceIsUsable = (res) => res.ok === true && Array.isArray(res.data?.balances);
var balanceCache = createCache(BALANCE_TTL_MS, "dsh-usage-dashboard:balance", balanceIsUsable, { sameDayOnly: true });
var usageCache = createCache(USAGE_TTL_MS, "dsh-usage-dashboard:usage", usageIsUsable, { sameDayOnly: true });
var getCachedBalance = () => balanceCache.get()?.data ?? null;
var getCachedBalanceAt = () => balanceCache.get()?.at ?? null;
...
async function fetchUsage(force = false) {
  ...
  const suffix = force ? "?refresh=1" : "";
  const task = getJson(`/api/dsh-usage-dashboard/usage${suffix}`, "no-store").then((res) => {
...
var zh = {
  ...
  "pricing.splitNote": "\u9AD8\u5CF0\u65F6\u6BB5\u4E3A\u5317\u4EAC\u65F6\u95F4 {windows}\uFF08\u5468\u4E00\u81F3\u5468\u4E94\uFF09\uFF1B\u5176\u4F59\u4E3A\u7A7A\u95F2\u65F6\u6BB5\uFF0C\u4EF7\u683C\u4E3A\u9AD8\u5CF0\u7684\u4E00\u534A\u3002\u6BCF\u6761\u7528\u91CF\u6309\u53D1\u751F\u65F6\u523B\u751F\u6548\u7684\u5B98\u65B9\u4EF7\u683C\u4F30\u7B97\u3002",
  "pricing.visionNote": "\u56FE\u7247\u6309\u5C3A\u5BF8\u6298\u7B97 token\uFF0C\u4E0E\u6587\u672C\u4E00\u5E76\u8BA1\u8D39\u3002",
  "pricing.modelNote": "deepseek-v4-flash\u3001deepseek-v4-flash-vision-exp \u662F\u65E7\u6A21\u578B\u540D\uFF0C\u73B0\u7531 deepseek-flash \u627F\u63A5\u5E76\u6309 Flash \u4EF7\u8BA1\u8D39\uFF1B2026-09-14 12:00 \u8D77 deepseek-v4-pro \u7684\u8BF7\u6C42\u4E5F\u4F1A\u8DEF\u7531\u5230 V4.1-Flash\uFF0C\u6309 Flash \u4EF7\u8BA1\u8D39\u3002",
  ...
  "peak.schedule": "\u9AD8\u5CF0\u65F6\u6BB5\u4E3A\u5317\u4EAC\u65F6\u95F4 {windows}\uFF08\u5468\u4E00\u81F3\u5468\u4E94\uFF09\uFF1B\u5468\u672B\u4E0E\u6CD5\u5B9A\u8282\u5047\u65E5\u4E3A\u7A7A\u95F2\u65F6\u6BB5\uFF0C\u4EF7\u683C\u4E3A\u9AD8\u5CF0\u7684\u4E00\u534A\u3002",
  "peak.activeHint": "\u628A\u6279\u91CF\u3001\u53EF\u5EF6\u540E\u7684\u4EFB\u52A1\u653E\u5230\u95F2\u65F6\u8DD1\uFF0C\u540C\u6837\u7684 token \u53EA\u8981\u4E00\u534A\u7684\u94B1\u3002",
  "vision.empty": "{window}\u6CA1\u6709\u56FE\u7247\u8F93\u5165\u3002",
  "vision.title": "\u56FE\u7247 / \u591A\u6A21\u6001\u7528\u91CF",
  "vision.images": "\u56FE\u7247\u5F20\u6570",
  "vision.tokens": "\u4F30\u7B97\u56FE\u7247 tokens",
  "vision.cost": "\u4F30\u7B97\u8D39\u7528",
  "vision.tokensShare": "\u5360\u8F93\u5165 {percent}%",
  "vision.costShare": "\u5360\u8D39\u7528 {percent}%",
  "vision.note": "\u56FE\u7247\u6309\u5B98\u65B9\u6362\u7B97\u89C4\u5219\u4F30\u7B97\uFF1A\u5148\u6309\u6BD4\u4F8B\u7F29\u653E\uFF08\u4E0A\u9650 ~800\xD7800\u3001\u4E0B\u9650 384\xD7384\uFF09\uFF0Ctoken \u4E0E\u7F29\u653E\u540E\u9762\u79EF\u6210\u6B63\u6BD4\u3001\u6BCF\u5F20\u4E0A\u9650 384\uFF1B\u56FE\u7247\u5F52\u5C5E\u5230\u968F\u540E\u4E00\u6B21\u6A21\u578B\u8C03\u7528\uFF0C\u6309\u8BE5\u8C03\u7528\u7684\u65F6\u6BB5\u4E0E\u6A21\u578B\u5355\u4EF7\u4F30\u7B97\uFF0C\u5B9E\u9645\u4EE5\u63A5\u53E3\u8FD4\u56DE\u7684\u7528\u91CF\u4E3A\u51C6\u3002",
  "vision.sessionsTitle": "\u56FE\u7247\u6700\u591A\u7684\u4F1A\u8BDD",
  "vision.sessionRow": "{images} \u5F20 \xB7 \xA5{cost}",
  "vision.dailyTitle": "{window} \xB7 \u6BCF\u5929\u56FE\u7247\u6570",
  "vision.barAria": "{date} \xB7 {images} \u5F20\u56FE\u7247 \xB7 \u4F30\u7B97 {tokens} tokens",
  "vision.barTitle": "{date} \xB7 {images} \u5F20\u56FE\u7247 \xB7 \u4F30\u7B97 {tokens} tokens \xB7 \xA5{cost}",
  ...
  "balance.todayConsumedEstimated": "\u4F30\u7B97",
  "balance.todayConsumedEstimatedTitle": "\u5F53\u65E5\u57FA\u51C6\u53D6\u81EA\u5F53\u5929\u9996\u6B21\u8F6E\u8BE2\uFF08\u63D2\u4EF6\u672A\u8DE8\u5348\u591C\u8FD0\u884C\uFF09\uFF0C\u51CC\u6668\u65F6\u6BB5\u7684\u6D88\u8D39\u53EF\u80FD\u672A\u8BA1\u5165\uFF0C\u5B9E\u9645\u4EE5\u5E73\u53F0\u4E3A\u51C6",
  ...
  "widget.staleAfterError": "\u4F59\u989D\u5237\u65B0\u5931\u8D25\uFF0C\u663E\u793A\u7684\u662F\u4E0A\u6B21\u6570\u636E",
  "widget.loading": "\u67E5\u8BE2\u4E2D\u2026",
...
var en = {
  ...
  "pricing.splitNote": "Peak periods are {windows} Beijing time, Monday to Friday; every other hour is off-peak and priced at half the peak rate. Each record is estimated at the official rates in force when it was written. ",
  "pricing.visionNote": "Images are converted to tokens by size and charged together with text. ",
  "pricing.modelNote": "deepseek-v4-flash and deepseek-v4-flash-vision-exp are legacy names, now served by deepseek-flash at Flash rates; from 2026-09-14 12:00 deepseek-v4-pro requests are routed to V4.1-Flash and billed at Flash rates. ",
  ...
  "peak.schedule": "Peak periods are {windows} Beijing time, Monday to Friday; weekends and statutory holidays are off-peak at half the peak price. ",
  "peak.activeHint": "Run batch or delay-tolerant work off-peak to pay half as much for the same tokens.",
  "vision.empty": "No image input in {window}.",
  "vision.title": "Image / multimodal usage",
  "vision.images": "Images",
  "vision.tokens": "Estimated image tokens",
  "vision.cost": "Estimated cost",
  "vision.tokensShare": "{percent}% of input",
  "vision.costShare": "{percent}% of cost",
  "vision.note": "Images are estimated with the official rule: resized keeping aspect ratio (cap ~800\xD7800, floor 384\xD7384), tokens proportional to the resized area with a 384-token cap per image. Each image is attributed to the next model call and priced at that call's period and model rate; the provider usage numbers remain the source of truth.",
  "vision.sessionsTitle": "Sessions with the most images",
  "vision.sessionRow": "{images} images \xB7 \xA5{cost}",
  "vision.dailyTitle": "{window} \xB7 images per day",
  "vision.barAria": "{date} \xB7 {images} images \xB7 est. {tokens} tokens",
  "vision.barTitle": "{date} \xB7 {images} images \xB7 est. {tokens} tokens \xB7 \xA5{cost}",
  ...
  "balance.todayConsumedEstimated": "estimate",
  "balance.todayConsumedEstimatedTitle": "The day-start baseline was seeded by the first poll of the day (the plugin did not run across midnight), so spend before that poll may be missing; the platform remains authoritative",
  ...
  "widget.staleAfterError": "Balance refresh failed \u2014 showing the last known value",
...
function getComposerInputElement(frame) {
...
function PricingNote(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("details", { className: "dq-pricing", children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("summary", { className: "dq-pricing-summary", children: [
      t("pricing.title"),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: `dq-pricing-now${pricing.inPeakNow ? " dq-pricing-now--peak" : ""}`, children: pricing.inPeakNow ? t("pricing.currentPeak") : t("pricing.currentOffPeak") })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dq-pricing-body", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("table", { className: "dq-pricing-table", children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("tr", { children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("th", { children: t("pricing.period") }),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("tbody", { children: pricing.tiers.map((tier) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_react4.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("tr", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("td", { rowSpan: 2, children: tier.model }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("td", { children: t("pricing.peak") }),
...
function VisionCard(props) {
  ...
  if (vision.images === 0) return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dq-empty", children: t("vision.empty", { window: windowLabel }) });
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dq-usage-totals", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Stat, { label: t("vision.images"), children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dq-stat-value", children: fmtInt(vision.images) }) }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Stat, { label: t("vision.tokens"), children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dq-stat-value", children: [
        fmtCompact(vision.imageTokens, locale),
        tokensShare > 0 && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dq-vision-share", children: t("vision.tokensShare", { percent: tokensShare.toFixed(1) }) })
      ] }) }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Stat, { label: t("vision.cost"), children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dq-stat-value", children: [
        "\xA5 ",
        fmt(vision.cost),
        costShare > 0 && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dq-vision-share", children: t("vision.costShare", { percent: costShare.toFixed(1) }) })
      ] }) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dq-chart-title", children: t("vision.dailyTitle", { window: windowLabel }) }),
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Bars, { data: bars, height: 80, labelEvery }),
    sessions.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dq-vision-sessions", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dq-chart-title", children: t("vision.sessionsTitle") }),
      sessions.map((session) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dq-session", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dq-session-head", children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dq-session-title", title: session.id, children: session.title }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dq-session-cost", children: t("vision.sessionRow", { images: fmtInt(session.images), cost: fmt(session.cost) }) })
      ] }) }, session.id))
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { className: "dq-cache-foot", children: t("vision.note") })
  ] });
}
function PeakCard(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dq-peak", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dq-peak-figures", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dq-stat", children: [
...
function BalanceDashboard(props) {
  ...
  const [balanceAt, setBalanceAt] = (0, import_react4.useState)(getCachedBalanceAt());
  ...
  const [composerWidth, setComposerWidth] = (0, import_react4.useState)(null);
  ...
  (0, import_react4.useLayoutEffect)(() => {
    ...
    const measure = () => {
      ...
      const input2 = getComposerInputElement(frame2);
      const inputRect = input2?.getBoundingClientRect() ?? null;
  ...
  const todayConsumedShown = balance !== null && balanceAt !== null && beijingDayKey(balanceAt) === beijingDayKey(Date.now()) ? balance.todayConsumed : null;
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dq-balance", ref: rootRef, style: composerSafeAreaStyle, children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dq-status-row", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dq-status-messages", children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(SyncStatus, { state: syncState, usageUpdatedAt }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dq-card dq-card--primary", children: [
      ...
      primary !== null ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dq-balance-grid", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Stat, { label: t("balance.todayConsumed"), children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
          "div",
          {
            className: "dq-stat-value",
            title: todayConsumedShown == null ? t("balance.todayConsumedEmpty") : balance?.todayConsumedEstimated === true ? t("balance.todayConsumedEstimatedTitle") : t("balance.todayConsumedTitle"),
            children: [
              todayConsumedShown == null ? "\u2014" : `${fmt(todayConsumedShown)} ${primary?.currency ?? ""}`,
              todayConsumedShown != null && balance?.todayConsumedEstimated === true && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dq-stat-note", children: t("balance.todayConsumedEstimated") })
            ]
          }
        ) })
    ...
    usage !== null && activeWindow !== null && activeWindow.vision !== void 0 && Array.isArray(activeWindow.visionDaily) && Array.isArray(activeWindow.visionSessions) ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dq-card", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dq-card-title", children: t("vision.title") }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
        VisionCard,
        {
    ...
    ] }) : usage === null ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dq-card", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dq-card-title", children: t("vision.title") }),
      loadingUsage ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dq-usage-totals", children: [64, 88, 72].map((w, i) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dq-stat", children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Skel, { w, h: 11 }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Skel, { w: 72, h: 20 })
      ] }, i)) }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dq-empty", children: t("vision.empty", { window: activeWindowName }) })
    ] }) : (
    ...
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dq-card", children: [
      ...
      usage !== null ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(PeakCard, { split: usage.peakSplit, pricing: usage.pricing }) : loadingUsage ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { className: "dq-footer", children: "@cassius0924/dsh-usage-dashboard v0.6.0" })
  ] });
}
...
function useVisibleInterval(callback, intervalMs) {
  const latest = (0, import_react6.useRef)(callback);
...
function QuotaWidget(props) {
  ...
  const [visible, setVisible] = (0, import_react7.useState)(widgetVisibleStore.get());
  (0, import_react7.useEffect)(() => widgetVisibleStore.subscribe(() => setVisible(widgetVisibleStore.get())), []);
  const [quotaViewActive2, setQuotaViewActive] = (0, import_react7.useState)(quotaViewActiveStore.get());
  (0, import_react7.useEffect)(() => quotaViewActiveStore.subscribe(() => setQuotaViewActive(quotaViewActiveStore.get())), []);
  const [lowBalance, setLowBalance] = (0, import_react7.useState)(lowBalanceStore.get());
  (0, import_react7.useEffect)(() => lowBalanceStore.subscribe(() => setLowBalance(lowBalanceStore.get())), []);
  const [selectedTabIds, setSelectedTabIds] = (0, import_react7.useState)(widgetTabIdsStore.get());
  (0, import_react7.useEffect)(() => widgetTabIdsStore.subscribe(() => setSelectedTabIds(widgetTabIdsStore.get())), []);
  const [viewTabs, setViewTabs] = (0, import_react7.useState)(() => props.views.list());
  (0, import_react7.useEffect)(() => props.views.subscribe(() => setViewTabs(props.views.list())), [props.views]);
  const [activeViewId, setActiveViewId] = (0, import_react7.useState)(null);
  const cachedBalance = getCachedBalance();
  const [data, setData] = (0, import_react7.useState)(cachedBalance?.data ?? null);
  const [error, setError] = (0, import_react7.useState)(null);
  const [loading, setLoading] = (0, import_react7.useState)(cachedBalance === null);
  const [collapsed, setCollapsed] = (0, import_react7.useState)(() => loadPref(COLLAPSED_KEY, isBoolean, false));
  const [pos, setPos] = (0, import_react7.useState)(null);
  const [corner, setCorner] = (0, import_react7.useState)(() => loadPref(CORNER_KEY, isCorner, "br"));
  ...
  const placeRef = (0, import_react7.useRef)(null);
  useVisibleInterval(() => placeRef.current?.(), 2e3);
  const readUsage = () => {
    const cached = getCachedUsage();
    return { data: cached?.ok === true ? cached.data ?? null : null, at: getCachedUsageAt() };
  };
  const [usage, setUsage] = (0, import_react7.useState)(readUsage);
  (0, import_react7.useEffect)(() => subscribeUsage(() => setUsage(readUsage())), []);
  const readSessionUsage = (id) => {
    if (id === void 0) return null;
    const response = getCachedSessionUsage(id);
    return response?.ok === true ? response.data ?? null : null;
  };
  const [sessionUsage, setSessionUsage] = (0, import_react7.useState)(() => readSessionUsage(sessionId));
  ...
  useVisibleInterval(readActiveView, 3e3);
  ...
  const dotClass = primary === null ? "dsh-quota-dot dsh-quota-dot--idle" : data?.isAvailable === false ? "dsh-quota-dot dsh-quota-dot--error" : low || error !== null ? "dsh-quota-dot dsh-quota-dot--warn" : "dsh-quota-dot";
  ...
  if (!collapsed) {
    if (loading && data === null && error === null) {
      ...
      body = /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "dsh-quota-body", children: [
        ...
        error !== null && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "dsh-quota-error", title: localizeApiError(error, t, "error.query"), children: t("widget.staleAfterError") })
      ] });
    } else {
      body = /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "dsh-quota-body", children: [
