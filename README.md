...
- 2026-08-17 00:00（北京时间）之前按旧的固定价；之后按峰谷价，闲时为高峰的一半。
- 2026-09-10 12:00 起 Flash 系列降价（V4.1-Flash），高峰时段同时收紧为**周一至周五**。
- 2026-09-14 12:00 起 `deepseek-v4-pro` 的请求由 V4.1-Flash 承接，按 Flash 价计费。
